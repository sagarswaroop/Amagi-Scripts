 ...
 */
 define(["N/record", "N/https"], function (record, https) {
  function afterSubmit(context) {
    if(["invoice", "creditmemo", "customerpayment"].indexOf(context.newRecord.type) === -1) {
      return;
    }
    ...
    if(context.newRecord.type == 'customerpayment'){
        webHookUrl = 'https://gc5s25anxjeuyys4afq2m2kgqi0pvgod.lambda-url.us-east-1.on.aws/receipt'
    }
